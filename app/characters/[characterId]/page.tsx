...
export default function CharacterDetailPage({ params }: { params: { characterId: string } }) {
  ...
  const customMap = {
    ...
    "Tournament Stalwart": "Tournament_Stalwart",
    "Sparkle of Youth":"Sparkle_of_Youth",
    "Anti-Fire": "Anti_Fire",
  ...
  const customIcons: { [key: string]: string } = {
    ...
    Fire_Unbound: "/elements/Enhancedfire.png",
    Water_Unbound: "/elements/Enhancedwater.png",
    Earth_Unbound: "/elements/Enhancedearth.png",
    Space_Unbound: "/elements/Enhancedspace.png",
    Wind_Unbound: "/elements/Enhancedwind.png",
    Dark_Unbound: "/elements/Enhanceddark.png",
    Light_Unbound: "/elements/Enhancedlight.png",
