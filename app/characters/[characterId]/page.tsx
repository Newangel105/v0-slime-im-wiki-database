...
export default function CharacterDetailPage({ params }: { params: { characterId: string } }) {
  ...
  const customMap = {
    ...
    "EX 5": "EX_5",
    "EX Unbound": "EX_Unbound",
    "EX Attack": "EX_Attack",
    "EX Balance": "EX_Balance",
    "EX Defense": "EX_Defense",
    "Fire Unbound": "Fire_Unbound",
    "Water Unbound": "Water_Unbound",
    "Earth Unbound": "Earth_Unbound",
    "Space Unbound": "Space_Unbound",
    "Wind Unbound": "Wind_Unbound",
    "Dark Unbound": "Dark_Unbound",
    "Light Unbound": "Light_Unbound",
    "Anti-Fire Unbound": "Anti_Fire_Unbound",
    "Anti-Water Unbound": "Anti_Water_Unbound",
    "Anti-Earth Unbound": "Anti_Earth_Unbound",
    "Anti-Space Unbound": "Anti_Space_Unbound",
    "Anti-Wind Unbound": "Anti_Wind_Unbound",
    "Anti-Dark Unbound": "Anti_Dark_Unbound",
    "Anti-Light Unbound": "Anti_Light_Unbound",
  }
  ...
  const customIcons: { [key: string]: string } = {
    ...
    EX_Unbound: "/stars/starCharaL7A.png",
    ...
    Fire_Unbound: "/elements/anti_fire_attribute_unbound.png",
    Water_Unbound: "/elements/anti_water_attribute_unbound.png",
    Earth_Unbound: "/elements/anti_earth_attribute_unbound.png",
    Space_Unbound: "/elements/anti_space_attribute_unbound.png",
    Wind_Unbound: "/elements/anti_wind_attribute_unbound.png",
    Dark_Unbound: "/elements/anti_dark_attribute_unbound.png",
    Light_Unbound: "/elements/anti_light_attribute_unbound.png",
    Anti_Fire_Unbound: "/elements/anti_fire_attribute_unbound.png",
    Anti_Water_Unbound: "/elements/anti_water_attribute_unbound.png",
    Anti_Earth_Unbound: "/elements/anti_earth_attribute_unbound.png",
    Anti_Space_Unbound: "/elements/anti_space_attribute_unbound.png",
    Anti_Wind_Unbound: "/elements/anti_wind_attribute_unbound.png",
    Anti_Dark_Unbound: "/elements/anti_dark_attribute_unbound.png",
    Anti_Light_Unbound: "/elements/anti_light_attribute_unbound.png",
