          ...
          {tiers.map((tier, idx) => {
            ...
            return (
              <div key={`tier-${idx}`} className="flex items-stretch">
                ...
                <div data-tier-index={idx} className="flex-1 min-h-[140px] md:min-h-[5rem] border border-gray-700/50 bg-[#0f1b2a]/80 text-white rounded-md flex items-start justify-between px-3 py-3 pr-0 md:pr-11 relative" onDragOver={(e) => e.preventDefault()} onDrop={(e) => handleDropOnTier(e as React.DragEvent, idx)}>
