...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#da3e44]/55 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border border-[#da3e44]/60 bg-card text-foreground shadow-lg shadow-[#da3e44]/20 hover:border-[#ef565c]/85 hover:bg-accent hover:shadow-[#da3e44]/30",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-border bg-card text-foreground hover:border-[#da3e44]/45 hover:bg-accent hover:text-foreground hover:shadow-[#da3e44]/15",
        secondary:
          "border border-border bg-card text-foreground hover:border-[#da3e44]/35 hover:bg-accent",
